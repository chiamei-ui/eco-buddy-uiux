...
> ⚠️ **英文標籤準據（2026-08-03 稽核補註）**：本表英文標籤為 RFP v1.4 **§4.1 主表**原文。RFP v1.4 §4.1 **附表 A／附表 B** 及命名手冊 v1.2 對其中 18 項型態（#02、#03、#04、#08、#09、#10、#11、#12、#13、#14、#16、#19、#21、#22、#23、#24、#25、#26）使用另一套英文標籤（如 #09 Sparkling Sprite、#24 Bouncy Daifuku）。甲方已裁定**以 §4.1 主表為準**（理由：主表為型態規格正表，且 §9.1 FX 表備註與附件驗收檢核表均引用主表版本）；附表與命名手冊之 label 欄修正將依合約第 11(1) 條以書面修訂辦理，`element_naming`（`state_*`）不受影響。修訂生效前，[NAMING.md](NAMING.md) §四仍保留附表 B 原文字。

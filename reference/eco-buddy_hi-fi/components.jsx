...
const ValueRise = ({ value, icon, color, top, left }) => (
  <div className="value-rise" style={{top, left, color: color || '#FF5A5F', display:'flex', alignItems:'center', gap:4}}>
